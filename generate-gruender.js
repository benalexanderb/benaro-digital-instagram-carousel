...
async function main() {
  ...
  const slide1 = slideRoot(
    ...
    h('div', { style: { display: 'flex', flex: '1', flexDirection: 'column', justifyContent: 'center', marginTop: '24px' } },
      h('div', { style: { display: 'flex', width: '940px', height: '900px', borderRadius: '28px', overflow: 'hidden', border: `1px solid ${C.cardBorder}` } },
        h('img', { src: founderB64, width: 940, height: 900, style: { objectFit: 'cover' } }),
      ),
    ),
    footer(),
  );
    ...
    h('div', { style: { display: 'flex', flex: '1', flexDirection: 'column', justifyContent: 'center' } },
      h('div', {
        style: {
          ...
          backgroundColor: C.cardBg, borderRadius: '28px', padding: '44px 40px',
        ...
        h('div', { style: { display: 'flex', flexDirection: 'column', gap: '26px' } },
          ...
          h('span', { style: { display: 'flex', fontFamily: 'Inter', fontSize: '31px', fontWeight: 500, color: C.text, lineHeight: '1.55' } },
          ...
          h('div', { style: { display: 'flex', width: '64px', height: '3px', backgroundColor: C.cardBorder } }),
          h('span', { style: { display: 'flex', fontFamily: 'Inter', fontSize: '31px', fontWeight: 500, color: C.textSoft, lineHeight: '1.55' } },
